#!/usr/bin/env python3
"""
Test script to verify the GUI application functionality.
This tests the core functionality without requiring a display.
"""
...
def test_repository():
    ...
    with tempfile.NamedTemporaryFile(mode='w', suffix='.csv', delete=False) as f:
        f.write("name,frequency_per_week,last_lesson_date,lesson_number_taken_so_far,status,is_online,billing_cycle,note,content\n")
        f.write("Alice Brown,1,2023-01-01,5,active,no,Monthly,Test note,\n")
        f.write("Bob Smith,2,2023-01-02,3,active,yes,Quarterly,Another note,\n")
        temp_csv = f.name
...
def test_student_model():
    ...
    assert student_dict["lesson_number_taken_so_far"] == str(student.lesson_number_taken_so_far)  # Should be string
...
def main():
    ...
    try:
        ...
        print("=" * 50)
        print("🎉 All tests passed! The native macOS app is working correctly.")
        print()
