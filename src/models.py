...
class Student:
    ...
    billing_cycle: str = "Monthly"  # Changed default from "Per Lesson" to "Monthly"
    note: str = ""
    content: str = ""
    ...
    def get_billing_message(self) -> Optional[str]:
        ...
        elif self.billing_cycle == "Monthly" and self.lesson_number_taken_so_far > 4:
            return "Monthly billing cycle completed (4 lessons)"
        elif self.billing_cycle == "Quarterly" and self.lesson_number_taken_so_far > 12:
    ...
    def from_series(cls, series) -> Student:
        ...
        return cls(
            ...
            lesson_number_taken_so_far=int(series["lesson_number_taken_so_far"]),
