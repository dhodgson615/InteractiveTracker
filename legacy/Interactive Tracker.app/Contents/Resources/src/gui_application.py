...
class GUIApplication:
    ...
    def _configure_styles(self) -> None:
        ...
        style.configure(
            "Large.TButton", font=("SF Pro Display", 14), padding=(20, 10)
        )
        ...
        style.configure(
            "Footer.TLabel", font=("SF Pro Display", 10), foreground="gray"
        )
    ...
    def _show_welcome_page(self) -> None:
        ...
        title_label = ttk.Label(
            self.main_frame, text="Lesson Sign-In", style="Title.TLabel"
        )
        title_label.grid(row=0, column=0, pady=(0, 10))

        # Welcome message
        welcome_label = ttk.Label(
            self.main_frame, text="Welcome!", style="Heading.TLabel"
        )
    ...
    def _show_new_student_page(self) -> None:
        ...
        name_label = ttk.Label(
            self.main_frame, text="Full Name:", style="Body.TLabel"
        )
        ...
        # Back button
        back_btn = ttk.Button(
            self.main_frame, text="Back", command=self._go_to_welcome
        )
    ...
    def _show_letter_select_page(self) -> None:
        ...
        # Title
        title_label = ttk.Label(
            self.main_frame, text="Returning Student", style="Title.TLabel"
        )
        title_label.grid(row=0, column=0, pady=(0, 10))
        ...
        question_label = ttk.Label(
            self.main_frame,
            text="What's the first letter of your first name?",
            style="Heading.TLabel",
        )
    ...
    def _show_student_select_page(self) -> None:
        ...
        # Title
        title_label = ttk.Label(
            self.main_frame, text="Student Selection", style="Title.TLabel"
        )
        title_label.grid(row=0, column=0, pady=(0, 10))
        ...
        if not self.page_manager.selected_letter:
            warning_label = ttk.Label(
                self.main_frame,
                text="No letter selected. Please select a letter first.",
                style="Body.TLabel",
            )
        ...
        students = self.student_repository.get_students_by_first_letter(
            self.page_manager.selected_letter
        )
        ...
        note_label = ttk.Label(
            self.main_frame, text="Add a note (optional):", style="Body.TLabel"
        )
        note_label.grid(row=4, column=0, sticky=tk.W, pady=(0, 5))

        note_text = tk.Text(
            self.main_frame, height=3, width=30, font=("SF Pro Display", 12)
        )
        ...
        signin_btn = ttk.Button(
            ...
            text="Sign In",
            style="Large.TButton",
            command=lambda: self._sign_in_student(
    ...
    def _show_success_page(self) -> None:
        ...
        lesson_number = self.page_manager.success_data[
            "lesson_number_taken_so_far"
        ]

        # Title
        title_label = ttk.Label(
            self.main_frame, text="Successful Sign-In", style="Title.TLabel"
        )
        title_label.grid(row=0, column=0, pady=(0, 10))
    ...
    def _show_footer(self) -> None:
        ...
        version_label = ttk.Label(
            footer_frame,
            text="Student Lesson Tracker v1.0",
            style="Footer.TLabel",
        )
    ...
    def _sign_in_student(self, note: str) -> None:
        ...
        try:
            updated_student = self.student_repository.update_student_lesson(
                selected_name, note
            )
    ...
    def _update_countdown(self) -> None:
        ...
        elapsed = (
            datetime.datetime.now() - self.page_manager.countdown_start
        ).total_seconds()
        ...
        if hasattr(self, "countdown_label"):
            if remaining > 0:
                self.countdown_label.config(
                    text=f"Returning to welcome screen in {int(remaining + 1)} seconds..."
                )
